...
def generate_rdl_from_parsed_info(sp_name: str, params: dict, fields: list, table_name: str) -> str:
    ...
    """
    rdl_template_content = """<?xml version="1.0" encoding="utf-8"?>
<Report xmlns="http://schemas.microsoft.com/sqlserver/reporting/2003/10/reportdefinition">
	...
	<DataSets>
		<DataSet Name="DataSet1">
			<Query>
				...
				<CommandText>hspl_Status_SubStatus_master_report</CommandText>
				<Timeout>300</Timeout>
				<QueryParameters>
	...
	<Body>
		...
		<ReportItems>
			<Table Name="Status SubStatus Master">
				<ZIndex>1</ZIndex>
				...
				<Style>
					<FontFamily>Calibri, Verdana, Arial, Helvetica</FontFamily>
				</Style>
				<Header>
	...
	<CodeModules>
		<CodeModule>rdlcodemoduleversion</CodeModule>
	</CodeModules>
</Report>"""
    try:
